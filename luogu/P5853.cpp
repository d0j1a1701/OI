...
long long n, kk, mod, fd, f[200010], res[200010], g[200010];
inline void mul(long long d) {
	for(int i = fd; i < fd + d; i++)
		f[i] = 0;
	fd += d;
	for(int i = 0; i < fd; i++)
		g[i] = (g[i - 1] + f[i]) % mod;
